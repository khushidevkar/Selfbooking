...
const Hotel: React.FC = () => {
  ...
  <div className="bg-white rounded-2xl shadow-lg pt-6 pb-12 px-6">
      ...
      {/* FORM GRID */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 border rounded-xl overflow-hidden">
        ...
        {/* ROOM & GUESTS */}
        <div className="p-4 border-r">
          <p className="text-xs font-semibold text-gray-500">Room & Guests</p>
          <p className="text-gray-400">1 Room, 2 Adults, 0 Children</p>
        </div>
